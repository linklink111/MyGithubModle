...
OUTPUT_FOLDER = r"E:\0CSDataBaseSystemPractise\MyProject\crawl_res"  # Folder where ZIP files will be stored
OUTPUT_CSV_FILE = r"E:\0CSDataBaseSystemPractise\MyProject\crawl_res\repositories.csv"  # Path to the CSV file generated as output
OUTPUT_CSV_FILE_1 = r"E:\0CSDataBaseSystemPractise\MyProject\crawl_res\repositories1.csv"  # Path to the CSV file generated as output
...
# csv_file = open(OUTPUT_CSV_FILE_1, 'w')
